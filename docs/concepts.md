...
Repair plans are schema-versioned (`schema_version: 4` as of v0.28). Apply rejects unsupported schema versions, plans for a different vault root, stale document hashes, conflicting field changes, and expected-old-value mismatches.
